...
describe("action make User in State", () => {
  it("should return DELETE_A_FOLDER_SUCCESS", () => {
    const prevState = [
            {
              _id: "dir_DOl2kN3n9lMeedN90kL9",
              object: "directory",
    ...
    const deleteFolderSuccess = makeDeleteFolderSucces("dir_DOl2kN3n9lMeedN90kL9")


    const expected = []
    
    expect(foldersReducer(prevState,deleteFolderSuccess)).toEqual(expected)
  })
})

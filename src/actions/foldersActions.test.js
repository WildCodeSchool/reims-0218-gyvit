import {
  ...
  deleteFolderAction,
  makeDeleteFolderSucces,
  DELETE_FOLDER_SUCCES
} from "./foldersActions"
...
//action DELETE_FOLDER_ACTION,


describe("action make User in State", () => {
  it("should return DELETE_FOLDER_ACTION", () => {
    const deleteOneFolderAction ={  type: DELETE_FOLDER_SUCCES,
      folderId: {_id: "dir_3ndN90kL9D9lMeeOl2kN",
      object: "directory",
      name: "Clients",
      created: "2018-03-29T00:00:00+00:00",
      modified: "2018-03-29T00:00:00+00:00",
    ...
    expect(makeDeleteFolderSucces ({_id: "dir_3ndN90kL9D9lMeeOl2kN",
    object: "directory",
    name: "Clients",
    created: "2018-03-29T00:00:00+00:00",
    modified: "2018-03-29T00:00:00+00:00",

import { addFilesSuccess } from "../actions/filesActions"

import addFiles from "./addFilesReducer"
...
describe("addFiles", () => {
  it("should not change the state for unhandled action", () => {
    ...
    const addFilesAction = addFilesSuccess({
      _id: "file_7F2jhzx5RlO8u5C1SP3c",
      object: "file",
      name: "TEST FOR POST",
      size: 0,
    ...
    expect(addFiles(prevState, addFilesAction)).toEqual(expectedState)
  })
})
